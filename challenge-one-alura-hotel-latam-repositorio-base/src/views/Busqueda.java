...
public class Busqueda extends JFrame {
	...
	private void eliminarReserva() {
        ...
        .ifPresentOrElse(fila -> {
            ...
            if(cantidadEliminada == 0) {
                JOptionPane.showMessageDialog(this, "No se pudo eliminar la reserva. Intentelo nuevamente.");
			}else {
                JOptionPane.showMessageDialog(this, String.format("%d item eliminado con exito!", cantidadEliminada));
			}
        }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
	}
	...
	private void eliminarHuesped() {
        ...
        .ifPresentOrElse(fila -> {
            ...
            if(cantidadEliminada == 0) {
                JOptionPane.showMessageDialog(this, "No se pudo eliminar el huesped. Intentelo nuevamente.");
			}else {
                JOptionPane.showMessageDialog(this, String.format("%d item eliminado con exito!", cantidadEliminada));
			}
        }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
        ...
        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
					...
					if(filasModificadas == 0) {
	                    JOptionPane.showMessageDialog(this, "No se pudo editar la reserva. Intentelo nuevamente.");
					}else {
        ...
        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
					...
					int filasModificadas = this.huespedController.modificar(id, nombre, apellido, nacimiento, nacionalidad,
							telefono);
					if(filasModificadas == 0) {
	                    JOptionPane.showMessageDialog(this, "No se pudo editar el huesped. Intentelo nuevamente.");
					}else {
	                    JOptionPane.showMessageDialog(this, String.format("%d item modificado con exito!", filasModificadas));
					}
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
