...
public class RegistroHuesped extends JFrame {
	...
	//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"	
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    private void guardandoHuesped(Reserva reserva) {
			if(txtNombre.getText() != null && txtApellido.getText() != null && txtFechaN.getDate() != null
				...
				Huesped huesped = new Huesped(txtNombre.getText(), txtApellido.getText(), new Date(txtFechaN.getDate().getTime()), 
						txtNacionalidad.getSelectedItem().toString(), txtTelefono.getText(), reserva);
				HuespedController huespedController =  new HuespedController();
				int confirmacionGuardadoHuesped = huespedController.guardarHuesped(huesped);
				if(confirmacionGuardadoHuesped != 0) {
					JOptionPane.showMessageDialog(null, "Los datos se han guardado correctamente. Su numero de reserva es: " 
							+ huesped.getReserva().getId());
				}else {
					JOptionPane.showMessageDialog(null, "Error en el registro. Verifica los datos ingresados.");
				}
			}else {
				JOptionPane.showMessageDialog(null, "Error en el registro. Verifica los datos ingresados.");
			}
